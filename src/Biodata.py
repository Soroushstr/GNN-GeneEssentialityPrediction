...
class GraphDataset():
    ...
    def process(self):
        ...
        print("Node feature shape:", self.pnode_feature.shape)
...
class Biodata:
    def __init__(self, fasta_file, label_file, feature_file, K=2, d=1):
        self.dna_seq = {}
        ...
        if feature_file == None:
            ...
            # self.other_feature = np.loadtxt('feature_file', delimiter=',', skiprows=1)
